...
public class MyWordCountTopology {
	...
	public static void main(String[] args) throws Exception {
		...
		builder.setSpout("spout", new RandomSentenceSpout(), 50);
		builder.setBolt("split", new SplitSentence(), 50).shuffleGrouping("spout");
		builder.setBolt("count", new WordCount(), 30).fieldsGrouping("split", new Fields("word"));
		...
		if (args != null && args.length > 0) {
			...
			//conf.setContainerMaxCpuHint(1f);
			//conf.setContainerMaxRamHint(4L * Constants.GB);
			...
			conf.setMaxTaskParallelism(3);
			//System.out.println("Max CPU requested is: " + topologyConfig.TOPOLOGY_CONTAINER_CPU_REQUESTED);
			//	System.in.read();
			//topologyConfig.setContainerMaxCpuHint(2);
