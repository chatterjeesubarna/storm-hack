...
public class PM10Spout extends BaseRichSpout implements IRichSpout{

	public static Logger LOG = LoggerFactory.getLogger(PM10Spout.class);
	...
	public void open(Map conf, TopologyContext context, SpoutOutputCollector collector) {
		...
		try{
			fileInput = new Scanner(new File(conf.get("PM10").toString()));
		}catch(Exception e){
